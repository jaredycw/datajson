...
def check_repeated_value(value):
    if value in check_repeated_value.previous_values:
        return True
    check_repeated_value.previous_values.add(value)
    return False
year = 1962
...
check_repeated_value.previous_values = set()  # Initialize set to store previous values
...
for i in range(60):
    ...
    if check_repeated_value(best_original_screenplay):
